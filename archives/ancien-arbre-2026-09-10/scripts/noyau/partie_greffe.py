...
def config(chemin):
    ...
    (`coups_par_camp`, `sieges`, `coups_interdits`), sinon `_courante.json` quand
    elle la nomme, sinon rien. Ici et non dans la vue : le greffe s'en sert pour
...
class Partie(object):
    ...
    def prevaut(self, bid):
        ...
        return b["camp"], "aucune clef ne le lève"
