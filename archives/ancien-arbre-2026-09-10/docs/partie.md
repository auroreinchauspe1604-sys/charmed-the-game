...
**Le caractère d'un camp joué par l'IA vit aussi là** (6.9 au soir,
`charmed-2`) : `caractere: {<camp>: "<texte>"}`. `partie_ia.py` le lit avant
sa table `CAMPS`, qui n'est plus que le défaut des parties qui n'en ont pas
écrit — on n'a plus à toucher au script pour ouvrir une partie.
