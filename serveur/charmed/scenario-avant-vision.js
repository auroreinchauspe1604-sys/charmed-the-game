"use strict";
const preparation = require('../../docs/parties/avant-la-vision-mecanique.json');
const resources = [
...
module.exports = {
 ...
 id:preparation.id,title:preparation.title,period:preparation.period,finalDay:12,subgoalSlots:require('./gameplay').evaluate(require('../../docs/parties/avant-la-vision-gameplay.json'),resources,12),
