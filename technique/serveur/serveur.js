...
const { envoyer, fichierStatique, fichierDepuis, CHEMINS } = require("./http");
...
const serveur = http.createServer((req, res) => {
  ...
  if (url.startsWith("/modules/charmed-assets/")) {
    const relatif = url.slice("/modules/charmed-assets/".length);
    return fichierDepuis(res, CHEMINS.visuelsJeu, relatif,
      TYPES[path.extname(relatif)] || "application/octet-stream");
  }
